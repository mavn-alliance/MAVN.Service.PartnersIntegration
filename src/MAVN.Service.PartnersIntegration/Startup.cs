...
using AutoMapper;
using MAVN.Service.PartnersIntegration.DomainServices.CallbackClient;
using MAVN.Service.PartnersIntegration.Profiles;
using Microsoft.Extensions.Http;

namespace MAVN.Service.PartnersIntegration
{
    [UsedImplicitly]
